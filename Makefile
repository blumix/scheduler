...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sun Apr 9 14:05:59 2017
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/scheduler1.0.0/ && $(COPY_FILE) --parents mainwindow.h group_profile.h teacher_profile.h room_profile.h group_dialog.h database.h .tmp/scheduler1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp group_profile.cpp teacher_profile.cpp room_profile.cpp group_dialog.cpp database.cpp .tmp/scheduler1.0.0/ && $(COPY_FILE) --parents mainwindow.ui group_dialog.ui .tmp/scheduler1.0.0/ && (cd `dirname .tmp/scheduler1.0.0` && $(TAR) scheduler1.0.0.tar scheduler1.0.0 && $(COMPRESS) scheduler1.0.0.tar) && $(MOVE) `dirname .tmp/scheduler1.0.0`/scheduler1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/scheduler1.0.0
